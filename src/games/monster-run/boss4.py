...
def boss4_loop():
    ...
    boss_image = pygame.image.load('./src/games/monster-run/images/4.png')
    ...
    projectile_image = pygame.image.load('./src/games/monster-run/images/nas.png')
    ...
    background_image = pygame.image.load('./src/games/monster-run/images/BossBg-1.png')
    background_image = pygame.transform.scale(background_image, (LARGEUR, HAUTEUR))

    ecran = pygame.display.set_mode((LARGEUR, HAUTEUR))
    pygame.display.set_caption("Boss Niveau 4")
    ...
    while True:
        ...
        afficher_infos_boss(1, "Boss 4", temps_restant)
