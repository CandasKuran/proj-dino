...
def charger_personnage():
    ...
    personnage_frames = [
        pygame.image.load('./src/games/monster-run/images/m1.png'),
        pygame.image.load('./src/games/monster-run/images/m2.png'),
        pygame.image.load('./src/games/monster-run/images/m3.png')
    ]
