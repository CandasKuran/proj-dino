...
def charger_personnage():
    ...
    personnage_frames = [
        pygame.image.load('./src/games/monster-run/images/main1.png'),
        pygame.image.load('./src/games/monster-run/images/main2.png'),
        pygame.image.load('./src/games/monster-run/images/main3.png')
    ]
