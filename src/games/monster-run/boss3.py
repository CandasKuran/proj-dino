...
def boss3_loop():
    ...
    boss_image = pygame.image.load('./src/games/monster-run/images/3.png')
    ...
    projectile_image = pygame.image.load('./src/games/monster-run/images/icescrum.png')
    ...
    background_image = pygame.image.load('./src/games/monster-run/images/City4.png')
    background_image = pygame.transform.scale(background_image, (LARGEUR, HAUTEUR))


    ecran = pygame.display.set_mode((LARGEUR, HAUTEUR))
    pygame.display.set_caption("Boss Niveau 3")
    ...
    while True:
        ...
        afficher_infos_boss(1, "Boss 3", temps_restant)
